...
export default function CategoryCard({ category, active, onSelect }) {
  return (
    <div
      className={`category-card d-flex flex-column ${active ? 'active' : ''}`}
      role="button"
      tabIndex={0}
    ...
    >
      ...
      <div className="d-flex align-items-center gap-1 small fw-bold mt-auto" style={{ color: active ? category.accent : undefined }}>
        {active ? (
          <>
